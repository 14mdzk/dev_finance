...
func (m *MockIUserRepository) Browse() ([]model.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserRepositoryMockRecorder) Browse() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Browse", reflect.TypeOf((*MockIUserRepository)(nil).Browse))
}
